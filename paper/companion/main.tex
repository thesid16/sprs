...
address the eight ports \sv{MAX\_PORTS} allows. The port is resolved by the
...
(\sv{3'd}$\langle p\rangle$, e.g.\ \sv{3'd7}) silently truncates port numbers above seven and breaks fat-tree
